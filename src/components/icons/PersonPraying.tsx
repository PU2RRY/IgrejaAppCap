// Icone "pessoa orando" no estilo Font Awesome Free (CC BY 4.0), nao existe equivalente no lucide-react.
export function PersonPraying({ size = 20, className = "" }: { size?: number; className?: string }) {
  return (
